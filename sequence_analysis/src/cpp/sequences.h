 ...
 */
  ...
  class SEQUENCE_ANALYSIS_API CategoricalSequenceProcess : public stat_tool::CategoricalProcess {  
  ...
  class SEQUENCE_ANALYSIS_API Correlation : public stat_tool::StatInterface , public stat_tool::Curves {
  ...
  class SEQUENCE_ANALYSIS_API Sequences : public stat_tool::StatInterface {
...
//                                         int max_nb_segment , segment_model *model_type) const;
  ...
  class SEQUENCE_ANALYSIS_API SequenceCharacteristics {
  ...
  class SEQUENCE_ANALYSIS_API SelfTransition : public stat_tool::Curves {
  ...
  class SEQUENCE_ANALYSIS_API MarkovianSequences : public Sequences {
